...
def _facts():
    return [
        {"fact": "Photosynthesis releases oxygen as a byproduct.", "source_title": "P", "source_url": ""},
        {"fact": "Chlorophyll absorbs light in the blue and red spectrum.", "source_title": "P", "source_url": ""},
    ]


def test_first_send_keeps_all(temp_db, embedder):
    db = temp_db
    db.add_subscription("a@b.com", "Photosynthesis", "daily", datetime.datetime.utcnow())
